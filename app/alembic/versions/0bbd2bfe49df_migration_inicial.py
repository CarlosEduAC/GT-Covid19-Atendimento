...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_atendimentos_visitas_id_atendimento'), table_name='atendimentos_visitas')
    op.drop_table('atendimentos_visitas')
    op.drop_index(op.f('ix_atendimentos_relacao_id_sintoma'), table_name='atendimentos_relacao')
    op.drop_index(op.f('ix_atendimentos_relacao_id_parentesco'), table_name='atendimentos_relacao')
    op.drop_index(op.f('ix_atendimentos_relacao_id_indicador'), table_name='atendimentos_relacao')
    op.drop_index(op.f('ix_atendimentos_relacao_id_doenca_cronica'), table_name='atendimentos_relacao')
    op.drop_index(op.f('ix_atendimentos_relacao_id_atendimento'), table_name='atendimentos_relacao')
    op.drop_table('atendimentos_relacao')
    op.drop_index(op.f('ix_atendimentos_orientacoes_finais_id_orientacao_final'), table_name='atendimentos_orientacoes_finais')
    op.drop_index(op.f('ix_atendimentos_orientacoes_finais_id_atendimento'), table_name='atendimentos_orientacoes_finais')
    op.drop_table('atendimentos_orientacoes_finais')
    op.drop_index(op.f('ix_atendimentos_motivos_sair_id_motivo_sair'), table_name='atendimentos_motivos_sair')
    op.drop_index(op.f('ix_atendimentos_motivos_sair_id_atendimento'), table_name='atendimentos_motivos_sair')
    op.drop_table('atendimentos_motivos_sair')
    op.drop_index(op.f('ix_atendimentos_estrategias_saudes_familiar_id_estrategia_saude_familiar'), table_name='atendimentos_estrategias_saudes_familiar')
    op.drop_index(op.f('ix_atendimentos_estrategias_saudes_familiar_id_atendimento'), table_name='atendimentos_estrategias_saudes_familiar')
    op.drop_table('atendimentos_estrategias_saudes_familiar')
    op.drop_index(op.f('ix_atendimentos_beneficios_sociais_id_beneficio_social'), table_name='atendimentos_beneficios_sociais')
    op.drop_index(op.f('ix_atendimentos_beneficios_sociais_id_atendimento'), table_name='atendimentos_beneficios_sociais')
    op.drop_table('atendimentos_beneficios_sociais')
    op.drop_index(op.f('ix_agendamentos_id_paciente'), table_name='agendamentos')
    op.drop_index(op.f('ix_agendamentos_id_atendimento'), table_name='agendamentos')
    op.drop_index(op.f('ix_agendamentos_id_adm_saude'), table_name='agendamentos')
    op.drop_table('agendamentos')
    op.drop_index(op.f('ix_atendimentos_id_tentativa'), table_name='atendimentos')
    op.drop_index(op.f('ix_atendimentos_id_paciente'), table_name='atendimentos')
    op.drop_index(op.f('ix_atendimentos_id_atendimento_inicial'), table_name='atendimentos')
    ...
    op.drop_index(op.f('ix_pacientes_id_genero'), table_name='pacientes')
    op.drop_index(op.f('ix_pacientes_id_etnia'), table_name='pacientes')
